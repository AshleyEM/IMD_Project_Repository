...
namespace Exploretum  // ALL QUEST SCREENS
{
    ...
    public class QuestActivity : Activity, ILocationListener
    {
        ...
        int[] scope_frames = Quest.scopeFrames;
...
// -------------- GPS CONTROL ------------
        public void OnLocationChanged(Location location)
        {
            ...
            spritePlaceholder.ScaleX = (float)1 - (float)distance * (float)0.02;
            spritePlaceholder.ScaleY = (float)1 - (float)distance * (float)0.02;
