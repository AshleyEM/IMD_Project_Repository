...
namespace Exploretum  // ALL QUEST SCREENS
{
    ...
    public class CheckpointActivity : Activity, ILocationListener
    {
        ...
        {           
            ...
            // Save current stop number for this quest (go back to prev story activty becase GPS breaks when reloading)
            SavedState.setStateOf(questNumber, stopNumber-1);
...
// -------------- GPS CONTROL ------------
        public void OnLocationChanged(Location location)
        {
            ...
            const int RANGE = 10; // How spread out distances are (smaller number = more frames). Multiplied by index of spectrescope frames.  
